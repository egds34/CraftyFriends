...
import { Trophy, BarChart3, LogOut, ImagePlus } from "lucide-react"
                        ...
                        <div className="flex flex-col gap-2">
                            {user.role === 'ADMIN' && (
                                <>
                                    ...
                                    <Link href="/admin/cms" className="flex items-center gap-3 p-3 rounded-md hover:bg-primary/10 transition-colors group">
                                        <div className="p-2 bg-indigo-500/10 rounded-full group-hover:bg-indigo-500/20 text-indigo-500">
                                            <ImagePlus className="h-5 w-5" />
                                        </div>
                                        <div className="flex flex-col">
                                            <span className="font-medium">Content Manager</span>
                                            <span className="text-xs text-muted-foreground">Images & Banners</span>
                                        </div>
                                    </Link>
                                </>
                            )}
